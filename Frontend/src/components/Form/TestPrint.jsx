...
const TestPrint = ({ formData }) => {
  ...
  const finalPurpose = formData.purposeOfDonation.includes("(Please Specify)")
    ? formData.purposeOfDonation.replace(
        "(Please Specify)",
  ...
  return (
    ...
    >
      ...
      <div
        style={{ position: "absolute", top: "4.07cm", left: "2.21cm" }}
        className="text-lg"
      >
        {formData.receiptId}
      </div>
      <div
        style={{ position: "absolute", top: "4.07cm", left: "15.9cm" }}
        className="text-lg"
      >
        {formData.date}
      </div>
      ...
      <div
        ...
        className="text-lg"
      >
        {formData.district}, {formData.state}, {formData.city} -{" "}
        {formData.pinCode}
      </div>
      <div
        style={{
      ...
      {formData.donationMethod === "Cheque" && (
        <>
          <div
            ...
            className="text-lg"
          >
            &#40;Cheque No: {formData.chequeNo}, Dated: {formData.dated}, On
            Bank: {formData.onBank}&#41;
          </div>
        </>
      )}
